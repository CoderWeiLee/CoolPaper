...
class MyController: UIViewController {
    override func viewDidLoad() {
        ...
        bezierPath.addLine(to: CGPoint(x: kScreenW, y: 0))
        bezierPath.addLine(to: CGPoint(x: kScreenW, y: 300))
        bezierPath.addQuadCurve(to: CGPoint(x: 0, y: 300), controlPoint: CGPoint(x: kScreenW * 0.5, y: 350))
        bezierPath.close()
//        bezierPath.stroke()
        
//        let topView = UIView(frame: CGRect(x: 0, y: 0, width: kScreenW, height: 400))
//        topView.addGradientColor(colors: [UIColor(hexString: "#FF62A5"), UIColor(hexString: "#FF632E")], locations: [0,1], direction: .Horizontal, targetView: topView)
