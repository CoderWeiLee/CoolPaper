...
import Alamofire
import MJRefresh
class MoreTypeController: UIViewController, UIScrollViewDelegate {
...
extension MoreTypeController: UICollectionViewDataSource, UICollectionViewDelegate {
