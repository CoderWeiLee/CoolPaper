...
class HXPHVideoView: UIView {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(lwappDidEnterBackground), name: UIApplication.willResignActiveNotification, object: nil)
    ...
    @objc func lwappDidEnterBackground() {
